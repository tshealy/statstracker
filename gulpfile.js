...
gulp.task('serve', shell.task(['python3 statstracker/manage.py runserver']));
...
gulp.task('deploy', function() {
  return gulp.src('statstracker/static/**/*').pipe(ghPages());
});
...
gulp.task('scss', function () {
  return gulp.src('./src/css/main.scss')
    ...
    .pipe(gulp.dest('statstracker/static/css'));
});
...
gulp.task('js', function () {
  ...
  return stream
    ...
    .pipe(gulp.dest('statstracker/static/js'));
});
...
gulp.task('html', function () {
  return gulp.src([src.allHtml, '!' + src.allViews])
    .pipe(gulp.dest('statstracker/static'));
});
